            ...
            <div className="space-y-6 text-zinc-300 text-sm sm:text-base mb-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="leading-relaxed text-zinc-400 text-xs sm:text-sm">
                    نحن فخورون بأن خاماتنا دائماً من أفخم أنواع القطن المصري الداعم للهيكل والتطريز الفخم والطباعة المقاومة للغسيل. يتم تمرير كل قطعة تيشيرت عبر محطتي فحص صارمة للجودة قبل إرسالها لشركة الشحن لضمان خروجها بحالة مثالية خالية تماماً من العيوب المصنعية.
                  </p>
                </div>
              </div>
            </div>
